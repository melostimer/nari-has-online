...
export function RecentOrdersList({ orders }: { orders: any[] }) {
  ...
  return (
    <div className="space-y-3">
      {orderList.map((order) => {
        ...
        return (
          <div key={order.id} className="bg-white rounded-2xl shadow-card overflow-hidden border border-gray-100 transition-all">
            ...
            {isOpen && (
              <div className="px-6 pb-5 border-t border-gray-100">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm text-gray-700">
                        <span className="font-medium w-20 text-gray-500">Ad Soyad</span>
                      ...
                      {order.notes && (
                        <div className="flex items-start gap-2 text-sm text-gray-500 italic">
                          <span className="font-medium w-20 not-italic">Not</span>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="pt-2 border-t flex justify-between font-bold text-gray-900">
                        <span>Toplam</span>
                        <span className="text-brand-600">{formatPrice(Number(order.totalPrice))}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-5 pt-4 border-t border-gray-100">
                  <p className="text-xs text-gray-400 mb-2 font-medium">Durumu Güncelle:</p>
